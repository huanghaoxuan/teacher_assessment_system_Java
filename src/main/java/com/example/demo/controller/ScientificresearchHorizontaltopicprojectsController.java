...
public class ScientificresearchHorizontaltopicprojectsController {
    ...
    public PageInfo<ScientificresearchHorizontaltopicprojects> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return scientificresearchHorizontaltopicprojectsService.selectAll(pageNum, pageSize, userinformation);
    }
}
