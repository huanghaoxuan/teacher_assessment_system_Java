...
public class OthersFilesController {
    ...
    public PageInfo<OthersFiles> selectAll(@ApiIgnore int pageNum, int pageSize, String departmentDept) {

        return othersFilesService.selectAll(pageNum, pageSize, departmentDept);
    }
}
