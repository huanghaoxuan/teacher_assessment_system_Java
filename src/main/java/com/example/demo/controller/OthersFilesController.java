...
public class OthersFilesController {
    ...
    public PageInfo<OthersFiles> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return othersFilesService.selectAll(pageNum, pageSize, userinformation);
    }
}
