...
public class ScientificresearchPublishpaperController {
    ...
    public PageInfo<ScientificresearchPublishpaper> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return scientificresearchPublishpaperService.selectAll(pageNum, pageSize, userinformation);
    }
}
