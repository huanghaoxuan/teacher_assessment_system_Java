...
public class TeachingconstructionLaboratoryconstructionController {
    ...
    public PageInfo<TeachingconstructionLaboratoryconstruction> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return teachingconstructionLaboratoryconstructionService.selectAll(pageNum, pageSize, userinformation);
    }
}
