...
public class TeachingconstructionTeachingtopicsController {
    ...
    public Integer updateByPrimaryKey(@ApiIgnore Integer id, String classTeacher, String status, String name, String source, String character, String type, String condition, String startTime, String endTime, String result, String note, Integer year) {
        TeachingconstructionTeachingtopics teachingconstructionTeachingtopics = new TeachingconstructionTeachingtopics(id, classTeacher, status, name, source, character, type, condition, startTime, endTime, result, note, year);
    ...
    public Integer insert(@ApiIgnore String classTeacher, String status, String name, String source, String character, String type, String condition, String startTime, String endTime, String result, String note, Integer year) {
        TeachingconstructionTeachingtopics teachingconstructionTeachingtopics = new TeachingconstructionTeachingtopics(classTeacher, status, name, source, character, type, condition, startTime, endTime, result, note, year);
    ...
    public PageInfo<TeachingconstructionTeachingtopics> selectAll(@ApiIgnore int pageNum, int pageSize) {

        return teachingconstructionTeachingtopicsService.selectAll(pageNum, pageSize);
    }
}
