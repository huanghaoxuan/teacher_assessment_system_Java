...
public class PublicaffairsSocialservicesController {
    ...
    public PageInfo<PublicaffairsSocialservices> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return publicaffairsSocialservicesService.selectAll(pageNum, pageSize, userinformation);
    }
}
