...
public class PublicaffairsSocialservicesController {
    ...
    public PageInfo<PublicaffairsSocialservices> selectAll(@ApiIgnore int pageNum, int pageSize) {

        return publicaffairsSocialservicesService.selectAll(pageNum, pageSize);
    }
}
