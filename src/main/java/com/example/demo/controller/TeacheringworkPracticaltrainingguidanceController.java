...
public class TeacheringworkPracticaltrainingguidanceController {
    ...
    public PageInfo<TeacheringworkPracticaltrainingguidance> selectAll(@ApiIgnore int pageNum, int pageSize, String departmentDept) {

        return teacheringworkPracticaltrainingguidanceService.selectAll(pageNum, pageSize, departmentDept);
    }
}
