...
public class TeacheringworkPracticaltrainingguidanceController {
    ...
    public PageInfo<TeacheringworkPracticaltrainingguidance> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return teacheringworkPracticaltrainingguidanceService.selectAll(pageNum, pageSize, userinformation);
    }
}
