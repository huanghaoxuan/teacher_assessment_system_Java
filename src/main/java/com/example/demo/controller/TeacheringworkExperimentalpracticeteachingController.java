...
public class TeacheringworkExperimentalpracticeteachingController {
    ...
    public PageInfo<TeacheringworkExperimentalpracticeteaching> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return teacheringworkExperimentalpracticeteachingService.selectAll(pageNum, pageSize, userinformation);
    }
}
