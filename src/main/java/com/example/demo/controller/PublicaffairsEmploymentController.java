...
public class PublicaffairsEmploymentController {
    ...
    public PageInfo<PublicaffairsEmployment> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return publicaffairsEmploymentService.selectAll(pageNum, pageSize, userinformation);
    }
}
