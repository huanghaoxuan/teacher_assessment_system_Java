...
public class TeachingconstructionTextbookconstructionController {
    ...
    public PageInfo<TeachingconstructionTextbookconstruction> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return teachingconstructionTextbookconstructionService.selectAll(pageNum, pageSize, userinformation);
    }
}
