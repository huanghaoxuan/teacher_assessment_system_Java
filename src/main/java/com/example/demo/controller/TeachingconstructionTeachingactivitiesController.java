...
public class TeachingconstructionTeachingactivitiesController {
    ...
    public Integer updateByPrimaryKey(@ApiIgnore Integer id, String classTeacher, String status, BigDecimal absent, BigDecimal lateDeparture, String note, Integer year) {
        TeachingconstructionTeachingactivities teachingconstructionTeachingactivities = new TeachingconstructionTeachingactivities(id, classTeacher, status, absent, lateDeparture, note, year);
    ...
    public Integer insert(@ApiIgnore String classTeacher, String status, BigDecimal absent, BigDecimal lateDeparture, String note, Integer year) {
        TeachingconstructionTeachingactivities teachingconstructionTeachingactivities = new TeachingconstructionTeachingactivities(classTeacher, status, absent, lateDeparture, note, year);
