...
public class TeacheringworkTeachingawardsController {
    ...
    public Integer updateByPrimaryKey(@ApiIgnore Integer id, String classTeacher, String status, String name, String type, String level, String grade, String character, Integer participantsNumber, String note, Integer year, String semester) {
        ...
        if (status.equals("通过")) {
            BigDecimal score = teacheringworkTeachingawardsService.getScore(type, level, grade, participantsNumber);
            teacheringworkTeachingawards.setScore(score);
        } else if (status.equals("不通过") || status.equals("未审核")) {
            teacheringworkTeachingawards.setScore(null);
        }
    ...
    public Integer insert(@ApiIgnore String classTeacher, String status, String name, String type, String level, String grade, String character, Integer participantsNumber, String note, Integer year, String semester) {
    ...
    public PageInfo<TeacheringworkTeachingawards> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return teacheringworkTeachingawardsService.selectAll(pageNum, pageSize, userinformation);
    }
}
