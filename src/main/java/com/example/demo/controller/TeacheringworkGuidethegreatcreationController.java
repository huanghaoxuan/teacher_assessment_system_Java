...
public class TeacheringworkGuidethegreatcreationController {
    ...
    public PageInfo<TeacheringworkGuidethegreatcreation> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return teacheringworkGuidethegreatcreationService.selectAll(pageNum, pageSize, userinformation);
    }
}
