...
public class TeachingconstructionComprehensivereformController {
    ...
    public PageInfo<TeachingconstructionComprehensivereform> selectAll(@ApiIgnore int pageNum, int pageSize, String departmentDept) {

        return teachingconstructionComprehensivereformService.selectAll(pageNum, pageSize, departmentDept);
    }
}
