...
public class TeachingconstructionComprehensivereformController {
    ...
    public Integer updateByPrimaryKey(@ApiIgnore Integer id, String classTeacher, String status, String character, String undertakingTasks, String note, Integer year, String semester) {
        TeachingconstructionComprehensivereform teachingconstructionComprehensivereform = new TeachingconstructionComprehensivereform(id, classTeacher, status, character, undertakingTasks, note, year, semester);
    ...
    public Integer insert(@ApiIgnore String classTeacher, String status, String character, String undertakingTasks, String note, Integer year, String semester) {
        TeachingconstructionComprehensivereform teachingconstructionComprehensivereform = new TeachingconstructionComprehensivereform(classTeacher, status, character, undertakingTasks, note, year, semester);
    ...
    public PageInfo<TeachingconstructionComprehensivereform> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return teachingconstructionComprehensivereformService.selectAll(pageNum, pageSize, userinformation);
    }
}
