...
public class TeacheringworkGuidecontestController {
    ...
    public PageInfo<TeacheringworkGuidecontest> selectAll(@ApiIgnore int pageNum, int pageSize) {

        return teacheringworkGuidecontestService.selectAll(pageNum, pageSize);
    }
}
