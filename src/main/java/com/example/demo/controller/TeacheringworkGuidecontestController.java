...
public class TeacheringworkGuidecontestController {
    ...
    public PageInfo<TeacheringworkGuidecontest> selectAll(@ApiIgnore int pageNum, int pageSize, String departmentDept) {

        return teacheringworkGuidecontestService.selectAll(pageNum, pageSize, departmentDept);
    }
}
