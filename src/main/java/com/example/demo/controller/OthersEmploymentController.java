...
public class OthersEmploymentController {
    ...
    public PageInfo<OthersEmployment> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return othersEmploymentService.selectAll(pageNum, pageSize, userinformation);
    }
}
