...
public class TeacheringworkClassroomteachingController {
    ...
    public PageInfo<TeacheringworkClassroomteaching> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return teacheringworkClassroomteachingService.selectAll(pageNum, pageSize, userinformation);
    }
}
