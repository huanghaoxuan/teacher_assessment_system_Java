...
public class OthersAnnualreviewstatusController {
    ...
    public PageInfo<OthersAnnualreviewstatus> findClassTeaching(@ApiIgnore String classTeacher, Integer year, int pageNum, int pageSize) {
        ...
        if (year != null) {
            othersAnnualreviewstatus.setYear(year);
        }
    ...
    public PageInfo<OthersAnnualreviewstatus> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return othersAnnualreviewstatusService.selectAll(pageNum, pageSize, userinformation);
    }
