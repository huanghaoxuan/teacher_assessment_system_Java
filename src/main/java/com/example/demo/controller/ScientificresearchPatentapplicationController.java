...
public class ScientificresearchPatentapplicationController {
    ...
    public PageInfo<ScientificresearchPatentapplication> selectAll(@ApiIgnore int pageNum, int pageSize, String classTeacher, String name, String departmentDept) {
        Userinformation userinformation = new Userinformation();
        userinformation.setName(name);
        userinformation.setClassTeacher(classTeacher);
        userinformation.setDepartmentDept(departmentDept);
        return scientificresearchPatentapplicationService.selectAll(pageNum, pageSize, userinformation);
    }
}
