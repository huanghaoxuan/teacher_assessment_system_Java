...
@RestController
@RequestMapping("/scoreGuidecontest")
@Api(tags = "【得分】指导学生比赛（毕业设计）获奖的数据接口")
public class ScoreGuidecontestController {

    @Autowired
    private ScoreGuidecontestService scoreGuidecontestService;

    @RequestMapping(value = "/selectByPrimaryKey", method = {RequestMethod.GET})
    @ApiOperation(value = "查询指导学生比赛（毕业设计）获奖", notes = "指导学生比赛（毕业设计）获奖查询接口")
    public ScoreGuidecontest selectByPrimaryKey() {
        return scoreGuidecontestService.selectByPrimaryKey(1);
    }


    @RequestMapping(value = "/updateByPrimaryKey", method = {RequestMethod.POST})
    @ApiOperation(value = "更新指导学生比赛（毕业设计）获奖", notes = "更新学生比赛（毕业设计）获奖查询接口")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "countryFirstDigit", value = "国际级一等（特等）奖", required = true, dataType = "decimal", paramType = "query"),
            @ApiImplicitParam(name = "countrySecondDigit", value = "国际级二等奖", required = true, dataType = "decimal", paramType = "query"),
            @ApiImplicitParam(name = "countryThirdDigit", value = "国际级三等奖", required = true, dataType = "decimal", paramType = "query"),
