...
public class ScoreGuidecontest implements Serializable {
    private Integer id;

    private BigDecimal internationalFirstDigit;

    private BigDecimal internationalSecondDigit;

    private BigDecimal internationalThirdDigit;
    ...
    public ScoreGuidecontest() {
    }

    public ScoreGuidecontest(Integer id, BigDecimal internationalFirstDigit, BigDecimal internationalSecondDigit, BigDecimal internationalThirdDigit, BigDecimal countryFirstDigit, BigDecimal countrySecondDigit, BigDecimal countryThirdDigit, BigDecimal provincialFirstDigit, BigDecimal provincialSecondDigit, BigDecimal provincialThirdDigit, BigDecimal cityFirstDigit, BigDecimal citySecondDigit, BigDecimal cityThirdDigit, BigDecimal schoolFirstDigit, BigDecimal schoolSecondDigit, BigDecimal schoolThirdDigit) {
        this.id = id;
        this.internationalFirstDigit = internationalFirstDigit;
        this.internationalSecondDigit = internationalSecondDigit;
        this.internationalThirdDigit = internationalThirdDigit;
    ...
    public BigDecimal getInternationalFirstDigit() {
        return internationalFirstDigit;
    }

    public void setInternationalFirstDigit(BigDecimal internationalFirstDigit) {
        this.internationalFirstDigit = internationalFirstDigit;
    }

    public BigDecimal getInternationalSecondDigit() {
        return internationalSecondDigit;
    }

    public void setInternationalSecondDigit(BigDecimal internationalSecondDigit) {
        this.internationalSecondDigit = internationalSecondDigit;
    }

    public BigDecimal getInternationalThirdDigit() {
        return internationalThirdDigit;
    }

    public void setInternationalThirdDigit(BigDecimal internationalThirdDigit) {
        this.internationalThirdDigit = internationalThirdDigit;
    }
    ...
    public String toString() {
        ...
        sb.append(", internationalFirstDigit=").append(internationalFirstDigit);
        sb.append(", internationalSecondDigit=").append(internationalSecondDigit);
        sb.append(", internationalThirdDigit=").append(internationalThirdDigit);
