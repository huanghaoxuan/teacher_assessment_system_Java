...
public class TeachingconstructionComprehensivereform implements Serializable {
    ...
    public TeachingconstructionComprehensivereform(String classTeacher, String status, String character, String undertakingTasks, String note, Integer year) {
    ...
    public TeachingconstructionComprehensivereform(Integer id, String classTeacher, String status, String character, String undertakingTasks, String note, Integer year) {
        this.id = id;
        this.classTeacher = classTeacher;
        this.status = status;
        this.character = character;
