...
public class TeacheringworkExperimentalpracticeteachingServiceImpl implements TeacheringworkExperimentalpracticeteachingService {
    ...
    @Override
    public PageInfo<TeacheringworkExperimentalpracticeteaching> selectAll(int pageNum, int pageSize, String departmentDept) {
        ...
        if (departmentDept != null && !departmentDept.equals("")) {
            ...
            teachings = teacheringworkExperimentalpracticeteachingMapper.selectAll();
        }
