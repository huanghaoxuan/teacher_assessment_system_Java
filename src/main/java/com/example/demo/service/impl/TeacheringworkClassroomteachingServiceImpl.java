...
public class TeacheringworkClassroomteachingServiceImpl implements TeacheringworkClassroomteachingService {
    ...
    @Override
    public PageInfo<TeacheringworkClassroomteaching> selectAll(int pageNum, int pageSize, Userinformation record) {
        ...
        for (int index = 0; index < teachings.size(); index++) {
            ...
            teacheringworkClassroomteaching.setClassTeacherName(userinformationService.selectByClassTeacher(userinformation).getName());
        }
